...
class CryptoFetchtron:
    ...
    def get_data_current(self, pair="BTC/USDT", limit=20, delay=60):
        """
            limit specifies how many queries at once are fetched.
            delay specifies how often request exchange server in sec.
        ...
        if self.exchange.has['fetchOHLCV']:
            while True:
                ...
                for i in range(len(bids)):
                    print("Pair: {}. Timestamp:{} .Order price: {} @ {} and Asks price: {} @ {}.\n"
    ...
    def show_pairs(self, pair_group="BTC"):
        """
            :@param pair_group: btc, eth, bnb, usdt... must be in capital
